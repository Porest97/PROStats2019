...
namespace PROStats2019.Controllers
{
    public class CoachesController : Controller
    {
        ...
        public CoachesController(PROStats2019Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Status")] Coach coach)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Status")] Coach coach)
        {
            if (id != coach.Id)
            {
                return NotFound();
