...
namespace PROStats2019.Controllers
{
    public class ClubsController : Controller
    {
        ...
        public ClubsController(PROStats2019Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClubName,StreetAddress,ZipCode,County,Country,PhoneNumber,Email")] Club club)
        {
            if (id != club.Id)
            {
                return NotFound();
