...
namespace PROStats2019.Controllers
{
    public class RefereesController : Controller
    {
        ...
        public RefereesController(PROStats2019Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Status")] Referee referee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Status")] Referee referee)
        {
            if (id != referee.Id)
            {
                return NotFound();
