...
namespace LcvDB.Controllers
{
    public class InteractionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,InteractionName,IsAdmin")] Interaction interaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InteractionName,IsAdmin")] Interaction interaction)
        {
